%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% File:         naval
% Description:  Apply TAGI to naval dataset
...
%% Data
path                     = char([cd ,'/data/']);
load(char([path, '/naval.mat']))
load(char([path, '/navalTestIndices.mat']))
load(char([path, '/navalTrainIndices.mat']))
nobs                     = size(data,1);
ncvr                     = 16;
% Input features
x                        = data(:,1:ncvr);
...
filename = 'naval4layer_softplus_FV1.mat';
